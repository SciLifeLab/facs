...
/*-------------------------------------*/
char *source, *all_ref, *position, *prefix, *clean, *contam, *clean2, *contam2, *merge_contam, *merge_clean;
/*-------------------------------------*/
  ...
  if (mytask == 0)
{
	...
	for (i = 1; i < ntask; i++)
	{
		char  *temp=(char *) malloc (1000* sizeof (char)),*temp2=(char *) malloc (1000* sizeof (char));
